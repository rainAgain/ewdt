...
(function($, exports) {
    ...
    $.extend(exports, {
        ...
        ajaxError: function(xhr, textStatus, errorThrown) {
            ...
            } else if($.inArray(xhr.status, [400, 401, 403, 404, 500, 503])) {
...
(function($, exports) {
    ...
    $.extend(exports, {
        ...
        isIEVer: function(ver) {
            ...
            if (ver === '7') {
                // ie7
                result = document.all && window.XMLHttpRequest && !document.querySelector;
            } else if (ver === '8') {
                // ie8
                result = document.all && document.querySelector && !document.addEventListener;
            } else if (ver === '9') {
                // ie9
                result = document.all && document.addEventListener && !window.atob;
            } else if (ver === '10') {
                // ie10
                result = document.all && window.atob;
            } else if (ver === '11') {
                // ie11
                result = '-ms-scroll-limit' in document.documentElement.style && '-ms-ime-align' in document.documentElement.style;
            }
...
(function($, exports) {
    ...
    $.extend(Template.prototype, {
        ...
        renderTo: function(id) {
            ...
            dom.innerHTML = M.render(this.tpl, this.view);
        }
    });
    ...
    $.extend(exports, {
        ...
        evalHtmlAttr: function(scopeId, data) {
            ...
            for(var i = 0, len = $els.length; i < len; i++) {
                ...
                if(evalstr) {
                    $el.attr(attr, Mustache.render(evalstr, data))
	...
	$.extend(Include.prototype, {
        ...
        fetch: function(success) {
            ...
            return $.ajax({
				...
				if(success) {
					rt = success(self.container, html);
				}

				self.container.innerHTML = ($.type(rt) === 'string' ? rt : html);
			});
        }
	});
...
(function($, exports) {
    ...
    $.extend(exports, {
        ...
        gotoUrl: function(url) {
            window.location.href = ResBoot.getPath(url);
        },

        replaceUrl: function(url) {
            window.location.replace(ResBoot.getPath(url));
        },
...
(function($, exports) {
    ...
    $.extend(exports, {
        runCommon:function() {
            ...
            // 真实接口 覆盖 mock接口
            $.extend(Config.ajaxUrls, Config.ajaxUrls.mock, Config.ajaxUrls.real);
